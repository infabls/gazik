...
<div class="container">
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="card-w">
				<h2 class="danger">Мастера по ремонту газовых плит</h2>
				<p>
					У Вас неисправна плита или ваша любимая посада стала закопченной, тогда мы предлагаем Вам контактные номера специалистов по ремонту и обслуживанию Плит
				</p>
				<p class="bg-info">
					<i class="fa fa-exclamation-triangle" aria-hidden="true"></i>
					Обязательно проверяйте наличие лицензии у вашей компании
				</p>
...
<!-- <div class="container">
	<div class="row">
		<div class="col-md-4 col-sm-6 col-xs-12">
			<div class="card-w">
				<div class="card_phone_cont">
					<div class="bg-servise bg-gas"></div>
					<div class="card_title">
						<h3>Товарищ №1</h3>
					</div>
					<p>
						Хотите быть уверенными что ваш газовый баллон полный, исправный и в нём газ высшего качества, тогда звоните нам и мы привезём Вам баллон в любую точку города по лучшей цене.
					</p>
				</div>
				<div class="card_index_phone">
					<div class="card__phone-icon">
						<a class="card__open-link" href="tel:+77232221568">+7 (7232) 50-31-68</a>
					</div>
				</div>
			</div>
		</div>
