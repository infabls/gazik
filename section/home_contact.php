...
<div class="container">
   <p class="text-center">Для просмора контактов выберите город</p>
  <ul class="nav nav-tabs nav-justified">
    <li ><a   href="/astana/contacts">Астана</a></li>
    <li><a  href="/karaganda/contacts">Караганда</a></li>
    <li><a  href="/pavlodar/contacts">Павлодар</a></li>
    <li><a  href="/ust-kamenogorsk/contacts">ВКО</a></li>
  </ul>
...
Отдел гос.закупок: 8 776 802 04 08</div>
        </div>
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="card-w"><h3>По вопросам сотрудничества звонить:</h3>

<p>Менеджеру по развитию: Диляра: <br>  8 707 181 02 18, 8 776 288 99 19, 8 707 666 58 99 <br>
